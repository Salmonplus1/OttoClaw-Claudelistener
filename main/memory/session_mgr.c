...
/* FNV-1a 32-bit hash — tiny, no deps, collision-resistant enough for session IDs.
 * Produces a stable 8-hex-char filename component regardless of chat_id length.
 * Max filename: "tg_XXXXXXXX.jsonl" = 17 bytes — well within SPIFFS 32-byte limit. */
